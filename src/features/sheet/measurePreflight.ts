...
const IMPORTED_INK_ACCIDENTAL_BONUS = 10;
const IMPORTED_INK_CHORD_PITCH_BONUS = 12;
const IMPORTED_INK_SHORT_EVENT_BONUS = 6;
const IMPORTED_INK_GRACE_NOTE_BONUS = 10;
const IMPORTED_INK_TUPLET_BONUS = 6;
const IMPORTED_INK_EXTRA_EVENT_BONUS = 6;
const IMPORTED_CHROMATIC_CHORD_FLOOR = 820;
